...
st.set_page_config(
    page_title="Tourism Package Predictor - Customer Purchase Predictor App",
    page_icon="📊",
    layout="wide"
)
...
if submitted:
    ...
    if prediction == 1:
        ...
        st.balloons()
        st.markdown("💡 **Insight:** Target this customer with premium packages and exclusive deals.")
    else:
        st.error("❌ Customer is NOT likely to purchase")
        st.markdown("💡 **Insight:** Consider offering discounts or follow-ups to improve conversion.")
